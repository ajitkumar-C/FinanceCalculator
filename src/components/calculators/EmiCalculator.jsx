    ...
    <div className="calculator-container">
      ...
      <section className="seo-rich-content-section" id="faq-section">
        ...
        <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '8px', marginBottom: '20px' }}>
          *Note: To verify your estimates, you can compare results with the official <a href="https://sbi.bank.in/web/student-platform/emi-calculator" target="_blank" rel="noopener noreferrer">SBI EMI Calculator</a> or check direct rates on the <a href="https://www.hdfc.bank.in/personal-loan/emi-calculator" target="_blank" rel="noopener noreferrer">HDFC Loan EMI Calculator</a>.
        </p>
